...
const des_dashboard=new express.Router();
...
des_dashboard.post("/get_des_dashboard",post,(req,res)=>{
    ...
    des_inspire.find().then((best_work)=>{
        ...
        des_portfolio_model.find({id_user:req.body.id_user}).then((user_best_work)=>{
            ...
            const res_dashboard={
                result:result,
                pic:user_best_work[0].pic
            }
            res.json(res_dashboard);
        })
    })
})


module.exports=des_dashboard;